...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2022 at 07:51 PM
...
INSERT INTO `inventory` (`inv_id`, `inv_name`, `inv_image`, `inv_qty`, `inv_min`, `inv_size`, `cate_id`, `inv_sub_id`) VALUES
('P0001', 'แมวส้ม', 'product220920074739174558578.jpg', 0, 0, 'XL', 1, 'P0001L'),
('P0001L', 'แมวส้ม', 'product220920074739174558578.jpg', 0, 0, 'L', 1, NULL);
