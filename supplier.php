...
<head>
  ...
  <title>ข้อมูลบริษัทคู่ค้าการผลิต - SOK Dashboard</title>
  ...
  <div class="main-container d-flex">
    ...
    <div class="content">
      ...
      <div class="dashboard-content px-3 pt-4">
        <h2 class="fs-5"> ข้อมูลบริษัทคู่ค้าการผลิต</h2>
        <hr>
    ...
    <?php } else {
      ...
      $(document).ready(function() {
        ...
        Swal.fire({
          icon: 'error',
          title: 'หน้าเพจนี้ได้สำหรับพนักงานจัดการคลังสินค้าหรือเจ้าของกิจการเท่านั้นเท่านั้น',
        }).then((result) => {
          history.back();
        });
      });
